...
const fetchAllStudentAD = () => {
    return axios.get("/Student/getAllAD", {
        headers: {
...
const deleteStudent = (id) => {
    return axios.delete(`/Student/delete?id=${id}`, {
        headers: {
            'Authorization': `Bearer ${token}`
        }
    });
...
export { fetchAllStudent, fetchAllStudentAD, postCreateStudent, postUploadIMG, putUpdateStudents, deleteStudent };