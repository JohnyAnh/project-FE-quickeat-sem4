  ...
  return (
    <Layout>
      <section
        ...
        style={{ backgroundImage: "url(assets/img/imageTheme/background-1.png)" }}
      >
          ...
          <div className="row align-items-center">
            ...
            >
              <div className="about-text">
                ...
                <h2>Thanks for ordering your order is being prepared by Quickeat</h2>
                <p>
            ...
            >
              <div className="about-img">
                <img alt="man" src="assets/img/imageTheme/photo-9.jpg" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row align-items-center">
            ...
            >
              <div className="our-mission-img">
                <img alt="Illustration" src="assets/img/imageTheme/illustration-5.png" />
              </div>
            </div>
            <div
          ...
          <div className="row align-items-center">
            ...
            >
              <div className="video-section-img">
                <img alt="elements" src="assets/img/imageTheme/elements-1.jpg" />
                <a
                  data-fancybox
          ...
          <div className="row align-items-center">
            ...
            >
              <div className="about-counters-img">
                <img alt="girl" src="assets/img/imageTheme/photo-10.png" />
              </div>
            </div>
            <div
              className="col-lg-6 col-md-12 col-sm-12"
          ...
          <div className="row">
            ...
            >
              <div className="our-team">
                <img alt="team-img" src="assets/img/imageTheme/team-1.png" />
                <h4>
                  {" "}
            ...
            >
              <div className="our-team">
                <img alt="team-img" src="assets/img/imageTheme/team-2.png" />
                <h4>
                  {" "}
            ...
            >
              <div className="our-team">
                <img alt="team-img" src="assets/img/imageTheme/team-3.png" />
                <h4>
                  {" "}
          ...
          >
            <SwiperSlide className="item">
              <div className="logo-img">
                <img alt="logo-img" src="assets/img/imageTheme/logo-1.png" />
                <h5>Kings Arms</h5>
              </div>
            </SwiperSlide>
            <SwiperSlide className="item">
              <div className="logo-img">
                <img alt="logo-img" src="assets/img/imageTheme/logo-2.png" />
                <h5>Wilmington</h5>
              </div>
            </SwiperSlide>
            <SwiperSlide className="item">
              <div className="logo-img">
                <img alt="logo-img" src="assets/img/imageTheme/logo-3.png" />
                <h5>Kennington</h5>
              </div>
            </SwiperSlide>
            <SwiperSlide className="item">
              <div className="logo-img">
                <img alt="logo-img" src="assets/img/imageTheme/logo-4.png" />
                <h5>The Victoria</h5>
              </div>
            </SwiperSlide>
            <SwiperSlide className="item">
              <div className="logo-img">
                <img alt="logo-img" src="assets/img/imageTheme/logo-5.png" />
      ...
      <section
        ...
        style={{ backgroundImage: "url(assets/img/imageTheme/background-img.jpg)" }}
      >
        <div className="container">
          <div className="row">
